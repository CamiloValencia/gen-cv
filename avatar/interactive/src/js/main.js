...
async function greeting() {
  ...
  let spokenText = "<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='https://www.w3.org/2001/mstts' xml:lang='en-US'><voice xml:lang='en-US' xml:gender='Female' name='en-US-JennyNeural'>【gesture.say-hi】 Hola, soy Megan, bienvenidos a esta feria donde podran conocer los proyectos de CT+I en el Instituto Colombiano del petroleo y energias para la transición. Estoy aqui para responder sus preguntas acerca de nuestra estrategia CT+I o cualquiera de nuestros proyectos. 【gesture.show-front-2】 ¿Como puedo ayudarte?</voice></speak>"
